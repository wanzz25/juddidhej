package com.wanzzdeploy.ehsbejj
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        webView.webChromeClient = object : WebChromeClient() {
            override fun onShowFileChooser(
                ...
                // Bungkus dengan Intent.createChooser supaya Android SELALU
                // nampilin popup pilihan (Foto & Video, Kamera, dll), bukan
                // langsung buka satu app default kalau kebetulan cuma ada
                // satu app yang cocok di device.
                val chooserIntent = Intent.createChooser(intent, "Pilih File")
                return try {
